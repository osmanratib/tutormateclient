 ...
 return (
  <div className=' flex items-center justify-center mt-12 '>
   <div className='border-2 rounded-xl shadow-xl shadow-white border-red-500 p-9 text-center'>
    ...
    {/* GOOGLE SIGN IN — DESIGN UNCHANGED */}
    ...
    <form onSubmit={handleSignIn} className='grid grid-cols-1 gap-3 justify-center items-center'>
     ...
     <div>
      ...
      <div className="bg-white w-[300px] h-[50px] rounded-xl p-2">
       <input
     ...
     <h1 className='capitalize font-Alegreya flex items-center justify-center mt-2 gap-2'>
